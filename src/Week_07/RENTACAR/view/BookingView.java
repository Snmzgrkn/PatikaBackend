...
import Week_07.RENTACAR.business.BookManager;
...
public class BookingView extends Layout{
    ...
    public BookingView(Car selectedCar,String strt_date,String fnsh_date){
        ...
        //test için
        this.fld_book_name.setText("Gürkan Sönmez");
        this.fld_book_idno.setText("12345677");
        this.fld_book_mail.setText("test@test.com");
        this.fld_book_mpno.setText("01231555123");
        this.fld_book_prc.setText("2350");
        this.txta_book_note.setText("Not bırakıldı deneme");
