...
public class BrandDao {
    ...
    public Brand match(ResultSet res) throws SQLException {
        Brand obj = new Brand();
        obj.setId(res.getInt("brand_id"));
        obj.setName(res.getString("brand_name"));
    ...
    public  Brand getById(int id){
        Brand obj = null;
        String quert = "SELECT * FROM public.brand WHERE brand_id = ?";
        try {
            PreparedStatement pr = this.connection.prepareStatement(quert);
            pr.setInt(1,id);
